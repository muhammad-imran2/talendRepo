...
public class j1 implements TalendJob {
	static {System.setProperty("TalendJob.log", "j1.log");}
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_V6YTYDRvEe6OOsrpF0E-3Q", "0.1");
...
public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "8KkWXs_" + subJobPidCounter.getAndIncrement());
...
public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "sU5dsj_" + subJobPidCounter.getAndIncrement());
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'j1' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_V6YTYDRvEe6OOsrpF0E-3Q");
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-08-06T15:55:21.332705200Z");
        ...
        try {
            ...
            java.io.InputStream inContext = j1.class.getClassLoader().getResourceAsStream("mdf_ft/j1_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j1.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
/************************************************************************************************
 *     50470 characters generated by Talend Cloud Data Management Platform 
 *     on the August 6, 2023 at 11:55:21 a.m. EDT
 ************************************************************************************************/